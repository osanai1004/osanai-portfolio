...
export const ui = {
	ja: {
		...
		'about.body1':
			'株式会社MOL CAREERでエンジニアチームリーダーとして、B2B 外国人材マッチング SaaS「Sunrise」の開発とチームマネジメントを担当しています。',
		'about.body2':
			'前職は法人向けフィールドセールス約 7 年。働きながら約 3 年・1,000 時間以上の独学を経て、2025 年に開発職へ転身しました。現在は技術的深度とビジネス・マネジメントの幅を併せ持つ「π 字型キャリア」を目指し、CTO への段階的な移行に取り組んでいます。',
		'about.stat1.value': '7年+',
		'about.stat1.label': '法人営業の経験',
		'about.stat2.value': '1,000時間+',
		'about.stat2.label': '独学での学習時間',
	...
	en: {
		...
		'about.body1':
			'I lead the engineering team at MOL CAREER Inc., where I develop "Sunrise," a B2B SaaS for global talent matching, while managing the team.',
		'about.body2':
			'Before engineering, I spent about 7 years in B2B field sales. After 3 years and 1,000+ hours of self-directed study, I moved into software development in 2025. I am now working toward a "π-shaped career" — deep technical skill combined with business and management breadth — on a step-by-step path to CTO.',
		'about.stat1.value': '7+ yrs',
		'about.stat1.label': 'B2B sales experience',
		'about.stat2.value': '1,000+ hrs',
		'about.stat2.label': 'Self-directed learning',
