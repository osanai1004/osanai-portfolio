...
export const ui = {
	ja: {
		...
		'hero.terminal.c.log.ki': '3b9 営業7年。300社と、課題は見えていた',
		'hero.terminal.c.log.sho': '7e2 でも解決を、自分の手では作れなかった',
		'hero.terminal.c.log.ten': 'a1c だから作る側へ。いま Team Lead',
		'hero.terminal.c.cmd.why': 'git show HEAD:why.txt',
		'hero.terminal.c.out.ketsu': '提案で終わらせず、届くプロダクトにする。',
		'about.eyebrow': 'About',
	...
	en: {
		...
		'hero.terminal.c.cmd.log': 'git log --reverse --oneline --about',
		'hero.terminal.c.log.ki': '3b9 7 years in sales. I could see the problems',
		'hero.terminal.c.log.sho': '7e2 But I could not build the fix myself',
		'hero.terminal.c.log.ten': 'a1c So I moved to building. Now Team Lead',
		'hero.terminal.c.cmd.why': 'git show HEAD:why.txt',
		'hero.terminal.c.out.ketsu': 'Do not stop at the proposal — ship the product.',
		'about.eyebrow': 'About',
