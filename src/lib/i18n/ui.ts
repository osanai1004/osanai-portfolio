...
export const ui = {
	ja: {
		...
		'hero.panel.label': 'whoami',
		'hero.panel.stack': 'Focus stack',
		'hero.terminal.prompt': 'osanai@lead:~$',
		'hero.terminal.cmd.whoami': 'whoami',
		'hero.terminal.out.name': SITE.nameJaReadable,
		'hero.terminal.out.role': 'Engineering Team Leader',
		'hero.terminal.cmd.mission': 'cat mission.txt',
		'hero.terminal.out.missionPrimary': '曖昧な要望を、届くプロダクトに。',
		'hero.terminal.out.missionSecondary': 'Turn ambiguous needs into shipped product.',
		'hero.terminal.cmd.focus': 'echo $FOCUS',
	...
	en: {
		...
		'hero.terminal.prompt': 'osanai@lead:~$',
		'hero.terminal.cmd.whoami': 'whoami',
		'hero.terminal.out.name': SITE.nameEn,
		'hero.terminal.out.role': 'Engineering Team Leader',
		'hero.terminal.cmd.mission': 'cat mission.txt',
		'hero.terminal.out.missionPrimary': 'Turn ambiguous needs into shipped product.',
		'hero.terminal.out.missionSecondary': '曖昧な要望を、届くプロダクトに。',
		'hero.terminal.cmd.focus': 'echo $FOCUS',
