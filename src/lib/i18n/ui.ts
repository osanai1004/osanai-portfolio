...
export const ui = {
	ja: {
		...
		'hero.terminal.c.cmd.log': 'git log --oneline --about',
		'hero.terminal.c.log.now': 'a1c 現在   Team Lead / B2B SaaS',
		'hero.terminal.c.log.switch': '7e2 2025   sales → engineering',
		'hero.terminal.c.log.sales': '3b9 ~2025  法人営業 7年 / 300社',
		'hero.terminal.c.cmd.why': 'git show HEAD:why.txt',
		'hero.terminal.c.out.why': '提案で終わらせず、自分の手で届ける。',
		'about.eyebrow': 'About',
	...
	en: {
		...
		'hero.terminal.c.cmd.log': 'git log --oneline --about',
		'hero.terminal.c.log.now': 'a1c now    Team Lead / B2B SaaS',
		'hero.terminal.c.log.switch': '7e2 2025   sales → engineering',
		'hero.terminal.c.log.sales': '3b9 ~2025  7y field sales / 300 companies',
		'hero.terminal.c.cmd.why': 'git show HEAD:why.txt',
		'hero.terminal.c.out.why': 'Carry it past the proposal — deliver it myself.',
		'about.eyebrow': 'About',
